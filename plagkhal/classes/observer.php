...
/**
 * observer.php - Moodle events handlers for plagkhal plagiairsm plugin
...
require_once($CFG->dirroot . '/plagiarism/plagkhal/classes/plagiarism_plagkhal_eventshandler.class.php');

/**
 * Moodle events handlers for plagkhal plagiairsm plugin
 */
class plagiarism_plagkhal_observer {
    /**
    ...
    public static function core_event_course_module_deleted(
        ...
        // Delete plagkhal module files.
        $DB->delete_records(
            'plagiarism_plagkhal_files',
            array('cm' => $cmid)
        );

        // Delete plagkhal module config.
        $DB->delete_records(
            'plagiarism_plagkhal_config',
            array('cm' => $cmid)
        );

        // Delete plagkhal module queued requests.
        $DB->delete_records(
    ...
    public static function core_event_user_deletion(\core\event\user_deleted $event) {
        $eventhandler = new plagiarism_plagkhal_eventshandler('user', 'deletion');
    ...
    public static function assignsubmission_file_event_assessable_uploaded(
        ...
        $eventhandler = new plagiarism_plagkhal_eventshandler('file_uploaded', 'assign');
    ...
    public static function assignsubmission_onlinetext_event_assessable_uploaded(
        ...
        $eventhandler = new plagiarism_plagkhal_eventshandler('content_uploaded', 'assign');
        $eventhandler->handle_submissions($event->get_data());
    }
    ...
    public static function mod_assign_event_assessable_submitted(
        ...
        $eventhandler = new plagiarism_plagkhal_eventshandler('assessable_submitted', 'assign');
        $eventhandler->handle_submissions($event->get_data());
    }
    ...
    public static function mod_workshop_event_assessable_uploaded(
        ...
        $eventhandler = new plagiarism_plagkhal_eventshandler('assessable_submitted', 'workshop');
        $eventhandler->handle_submissions($event->get_data());
    }
    ...
    public static function mod_forum_event_assessable_uploaded(
        ...
        $eventhandler = new plagiarism_plagkhal_eventshandler('assessable_submitted', 'forum');
        $eventhandler->handle_submissions($event->get_data());
    }
    ...
    public static function mod_quiz_event_attempt_submitted(
        ...
        $plugin = new plagiarism_plagkhal_eventshandler('quiz_submitted', 'quiz');
