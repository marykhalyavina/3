...
$string['plagkhal'] = 'Проверка плагиата';
...
$string['clstudentdisclosuredefault']  = 'Отправляя свои файлы, вы соглашаетесь с политикой конфиденциальности';
...
$string['claccountconfig'] = "Ссылка на сервер проверки на плагиат";
$string['clapiurl'] = 'Ссылка';
$string['claccountkey'] = "plagkhal key";
$string['claccountsecret'] = "plagkhal secret";
$string['clallowstudentaccess'] = 'Разрешить учащимся доступ к отчетам о плагиате';
$string['clinvalidapiurl'] = 'Неверный адрес';
...
$string['clpoweredbyplagkhal'] = 'Работает на локальном сервере проверки на плагиат';
...
$string['privacy:metadata:plagiarism_plagkhal_files'] = 'Информация, связывающая отправку Moodle с отправкой на сервер проверки на плагиат.';
$string['privacy:metadata:plagiarism_plagkhal_files:userid'] = 'Идентификатор пользователя, являющегося владельцем отправки.';
$string['privacy:metadata:plagiarism_plagkhal_files:submitter'] = 'Идентификатор пользователя, сделавшего отправку.';
$string['privacy:metadata:plagiarism_plagkhal_files:similarityscore'] = 'Степень сходства отправки.';
$string['privacy:metadata:plagiarism_plagkhal_files:lastmodified'] = 'Временная метка, указывающая, когда пользователь последний раз модифицировал свою отправку.';
$string['privacy:metadata:plagiarism_plagkhal_client'] = 'Необходимо получить некоторые данные о пользователе.';
$string['privacy:metadata:plagiarism_plagkhal_client:module_id'] = 'Идентификатор модуля, отправленный для идентификации.';
$string['privacy:metadata:plagiarism_plagkhal_client:module_name'] = 'Название модуля, отправленное для идентификации.';
$string['privacy:metadata:plagiarism_plagkhal_client:module_type'] = 'Тип модуля, отправленный для идентификации.';
$string['privacy:metadata:plagiarism_plagkhal_client:module_creationtime'] = 'Время создания модуля, отправленное для идентификации.';
$string['privacy:metadata:plagiarism_plagkhal_client:submittion_userId'] = 'Идентификатор пользователя отправки, отправленный для идентификации.';
$string['privacy:metadata:plagiarism_plagkhal_client:submittion_name'] = 'Имя, отправленное для идентификации.';
$string['privacy:metadata:plagiarism_plagkhal_client:submittion_type'] = 'Тип отправки, отправленный в plagkhal для идентификации.';
$string['privacy:metadata:plagiarism_plagkhal_client:submittion_content'] = 'Содержание отправки, отправленное в plagkhal для обработки сканирования.';